  ...
  <div class="row">
    ...
    <table class="table table-bordered text-center">
      ...
      ?>
        ...
        <tr>
          ...
          <td><input type="text" name="qty" class="form-input w-50" placeholder=""></td>
          ...
          <td>
            ...
            class="bg-warning px-3 py-2 border-0 mx-3" name="update_cart">

            <input type="submit" value="Remove Cart"
            class="bg-warning px-3 py-2 border-0 mx-3" name="remove_cart">
          </td>
        </tr>
    <?php 
        }
    ...
    <div class="d-flex mb-3">
      <?php 
        ...
        $result_count=mysqli_num_rows($result);
        if($result_count>0){
          echo "<h4 class='px-3'>Sub Total: <strong class='text-warning'> $total_price .00</strong></h4>

           <input type='submit' value='Continue Shopping'
            class='bg-warning px-3 py-2 border-0 mx-3' name='continue_shopping'>
